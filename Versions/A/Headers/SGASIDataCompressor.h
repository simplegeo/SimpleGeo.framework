...
// This is a helper class used by SGASIHTTPRequest to handle deflating (compressing) data in memory and on disk
...
@interface SGASIDataCompressor : NSObject {
	BOOL streamReady;
	z_stream zStream;
}
